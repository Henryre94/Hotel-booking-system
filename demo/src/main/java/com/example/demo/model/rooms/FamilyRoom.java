...
//    private Customer customer;
    ...
    @ManyToMany(mappedBy = "familyRooms")
    private Set<Reservation> reservations =new HashSet<>();

    public FamilyRoom() {
    }

    public FamilyRoom(boolean isAvailable, Bed typeOfBed, double pricePerNight, boolean breakfast, int roomNumber,int maxNumberOfResidents) {
