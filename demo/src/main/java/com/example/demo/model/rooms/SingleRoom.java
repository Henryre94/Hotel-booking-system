...
//    private Customer customer;
    ...
    @ManyToMany(mappedBy = "singleRooms")
    private Set<Reservation> reservations =new HashSet<>();

    public SingleRoom(){}

    public SingleRoom(boolean isAvailable, Bed typeOfBed, double pricePerNight, boolean breakfast, int roomNumber,int maxNumberOfResidents) {
