...
//    private Customer customer;
    ...
    @ManyToMany(mappedBy = "doubleRooms")
    private Set<Reservation> reservations =new HashSet<>();

    public DoubleRoom() { }


    public DoubleRoom(boolean isAvailable, Bed typeOfBed, double pricePerNight, boolean breakfast, int roomNumber,int maxNumberOfResidents) {
